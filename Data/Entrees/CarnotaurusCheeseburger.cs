...
* File name: CarnotaurusCheeseburger.cs
* Purpose: represents an entree of CarnotaurusCheeseburger
*/
...
{
    /// <summary>
    /// A class representing an entree of CarnotaurusCheeseburger.
    /// </summary>
    public class CarnotaurusCheeseburger: Burger, INotifyPropertyChanged, IMenuItem
    {
        /// <summary>
        /// Constructs a new CarnotaurusCheeseburger.
        /// </summary>
        ...
        public override ICollection<string> SpecialInstructions
        {
            get
            {
                ...
                if (!AmericanCheese) instructions.Add("Hold AmericanCheese");
        ...
        {
            return "Carnotaurus Cheeseburger";
        }
